        ...
        <table className="w-full text-left text-xs sm:text-sm text-gray-300">
          ...
          <tbody>
            ...
            {sortedUsers.map((user) => {
              ...
              let roleStyle = "bg-emerald-500/20 text-emerald-300 border border-emerald-500/30";

              if (user.role === "admin") {
                roleStyle = "bg-purple-500/20 text-purple-300 border border-purple-500/30";
              } else if (user.role === "pharmacist") {
                roleStyle = "bg-blue-500/20 text-blue-300 border border-blue-500/30";
              }
              ...
              return (
                ...
                >
                  <td className="py-3 px-3 font-medium text-white flex items-center gap-2 whitespace-nowrap">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold text-xs">
                      {firstLetter}
                    </div>
                  ...
                  <td className="py-3 px-3 whitespace-nowrap">
                    <span
                      className={`px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-semibold capitalize ${roleStyle}`}
                    >
                      {user.role}
                    </span>
                  </td>
