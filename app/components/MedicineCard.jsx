...
export default function MedicineCard({  image,  name,  category,  company,  price,oldPrice,discount,}) {
  return (
    <div className="bg-[#141B2D] rounded-3xl overflow-hidden border border-gray-700 hover:border-green-500 transition hover:scale-102">
      ...
      <div className="relative">
        ...
        {/* <span className="absolute top-3 left-3 bg-orange-500 text-xs px-3 py-1 rounded-full text-white">
          Rx Required
        </span> */}
